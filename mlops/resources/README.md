...
ML Resource Configurations in this directory:
 ...
 - monitoring workflow (`mlops/resources/monitoring-workflow-resource.yml`)
...
Following this, update the batch_inference_job base parameters in `mlops/databricks-resource/batch-inference-workflow-resource.yml` to pass
